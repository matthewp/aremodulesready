...
class AreModulesReady extends Component {
  constructor() {
    ...
    this.dynamic = [chrome(false), firefox(false), edge(false), safari(true, true)];
  }
        ...
        fritz.h(
          ...
          fritz.h(
            ...
            fritz.h(
              ...
              ': Available in Chrome 60 (currently in Canary) behind a flag. Enable ',
              fritz.h(
                'strong',
                null,
                'Experimental Web Platform features'
              ),
              ' in chrome://flags to use.'
            ),
            fritz.h(
              'div',
              { 'class': 'note' },
